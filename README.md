# PDF/EPUB Reader with Gemini

## 概要 / Overview

日本語:

PDF/EPUB Reader with Gemini は、PySide6 ベースのローカルデスクトップ向け PDF / EPUB ビューアです。ドキュメントを画像として表示しながら、選択した範囲を Gemini に送信して翻訳、解説付き翻訳、カスタム解析を行えます。
...
PDF/EPUB Reader with Gemini is a local desktop PDF/EPUB viewer built with PySide6. It renders documents as images and lets you send selected regions to Gemini for translation, translation with explanation, and custom analysis.
